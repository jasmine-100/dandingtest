...
public class WmsStockinApi {
    String orderno = "ET202012291742090332811817";
    ...
    public void backStockin(){
        ...
        skuParams.add(new SkuParam("SKU201229109","202012270001",100,1,1,"2020-12-01","2020-12-31"));
//        skuParams.add(new SkuParam("SKU201229106","202012270001",10,1,1,"2020-12-01","2020-12-31"));
//        skuParams.add(new SkuParam("SKU20122404","2020102802",100,1,1,"2020-12-01",10));
