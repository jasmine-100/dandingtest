...
public class WmsStockinApi {
    ...
    public void backStockin(){
        ...
        skuParams.add(new SkuParam("SKU201225005","202012270001",10,1,1,"2020-12-01","2020-12-31"));
        skuParams.add(new SkuParam("SKU201225005","202012270002",10,2,2,"2020-12-01","2020-12-31"));
