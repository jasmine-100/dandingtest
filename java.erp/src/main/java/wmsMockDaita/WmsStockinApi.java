...
public class WmsStockinApi {
    ...
    public void backStockin(){
        ...
        skuParams.add(new SkuParam("G1607589928737","20201111",100,1,1,"2020-11-20 00:00:00","2023-12-07 00:00:00"));
//        skuParams.add(new SkuParam("G1607589928737","20201210",2000,1,2,"2020-11-20 00:00:00","2022-12-07 00:00:00"));
//        skuParams.add(new SkuParam("G1607589928737","20201210",2000,1,2,"2020-11-20 00:00:00","2022-12-07 00:00:00"));

        StockinOrder stockinOrder = new StockinOrder("ET202012111033380490585346",Data.warehouseCode,Data.ownerCode,0,"1",skuParams,"2020-10-10 12:00:00","2020-10-20 15:00:00");
