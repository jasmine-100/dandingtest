...
public class WmsStockoutApi {
    String orderno = "OB202101131556230919766566";
    ...
    public void backStockout(){
        ...
        skuParams.add(new SkuParam("SKU201225005","210104170201",9,1,1,"2020-12-01","2020-12-31"));
        skuParams.add(new SkuParam("SKU201229109","202012270001",8,1,2,"2020-12-01","2020-12-31"));
