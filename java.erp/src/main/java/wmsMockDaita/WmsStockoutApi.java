...
public class WmsStockoutApi {
    String orderno = "OB202101201033180006965010";
...
//        skuParams.add(new SkuParam("SKU2101141458","210115001",3,1,1,"2020-12-01","2020-12-31"));//保税
        skuParams.add(new SkuParam("SKU2101141457","2101141527",1,1,1,"2020-12-01","2020-12-31"));//完税

        StockoutOrder order = new StockoutOrder(orderno,Data.warehouseCode,Data.ownerCode,"ZTO","75431552392506",1,skuParams,"2020-12-01 10:00:00","2020-12-01 11:00:00");
