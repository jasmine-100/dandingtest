...
public class WmsStockoutApi {
    ...
    public void backOrder(){
        ...
        skuParams.add(new SkuParam("G1607323305467","20201216",10,1,1,"2020-11-20 00:00:00","2022-11-10 00:00:00"));
//        skuParams.add(new SkuParam("G1606549582326","20201128",20,1,2,"2020-11-20 00:00:00","2022-11-10 00:00:00"));

        StockoutOrder order = new StockoutOrder("OB202012071556440459153745",Data.warehouseCode,Data.ownerCode,"SF","SF"+str,1,skuParams,"2020-12-01 10:00:00","2020-12-01 11:00:00");
