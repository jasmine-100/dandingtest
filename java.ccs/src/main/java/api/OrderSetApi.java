...
//        Order order = new Order(orderno,"ZTO","Z"+new Random(999999),"jasRoute", items);
        Order order = new Order("xiaoyuer","小鱼儿",orderno,"SF","SF"+new Random().nextInt(999999),"jasRoute", items);
...
//        dingdanBack(orderno);
    ...
    public void qingdanBack() throws IOException, InterruptedException {
        // 取申报单的数据库id
        String orderno = "498494589842227201";
        // 回执清单号
...
//        String invtNo = "QD20200805151953";
        ...
        // 回执：税金
        BackTax.backTaxrd(invtNo,100,5.2,3.6,"20200809112920102");
