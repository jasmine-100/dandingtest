...
public class Diaobo {
    ...
    public Diaobo(String applyNo,String sendNotice,String warehouseId,String customerId,String expectDate,List<Good> goodList) {
        ...
        this.note1 = "快点儿发货";
        this.sendAddress = "浙江省杭州市上城区九堡科技园25幢2楼";
