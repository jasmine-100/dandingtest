package test.ccs.testcase.dto.back;

import test.ccs.testcase.Data;
import test.ccs.testcase.dto.Param;
...
//        new ApiClient(BaseParam.URL_BACK).doPostForm(new Param(data,"other"));
        ApiClient.doPostForm(Data.URL_BACK,null,null,new Param(data,"other"));
    }
}
