...
public class CaseStockinPurchase {
    // 入库单编号
    String orderId = "ET20200828170615579266";
    // 入库商品sku
    String sku = "sku08281548";

    @Test
    public void inPurchase() throws Exception {
        BackStockin.backPurStockin(orderId,sku,100,1,"","","","ZP",0);
    }
    ...
    public void inPurchaseBatch() throws Exception {
        BackStockin.backPurStockin(orderId,sku,100,1,"20200811","2020-08-11 10:00:50","2025-08-11 10:00:50","CP",0);
    }
